  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() => router.push('/dotaciones/nueva')}
        ...
        <>
          {dotaciones.length === 0 ? (
            <div className="text-center py-12 text-slate-400">
              No hay dotaciones para este evento.{' '}
              <button onClick={() => router.push('/dotaciones/nueva')} className="text-blue-600 hover:underline">
                Crear la primera
              </button>
            </div>
          ) : (
